    ...
    <body>
        ...
        <%
            ...
            if (userPostList == null) {
                out.println("Error: Post list is not available.");
                return;
            }
                            ...
                            <div class="row no-gutters">
                                <div class="contact-wrap w-100 p-md-5 p-4">
                                    <form method="post" action="../EditPost" enctype="multipart/form-data">
                                        <div class="row">
                                            <input type="hidden" name="postId" value="<%= thePost.getPostid() %>">
                                            <input type="hidden" name="totalLike" value="<%= thePost.getTotallike() %>">
                                            <div class="form-group" style="width:100%;">
                                                <label class="label" for="image">Current image:</label><br>
                                                <img src="data:image/png;base64,<%= thePost.getPicBase64() %>" alt="Image" style="display:block; max-width: 100%; height: auto; margin-top: 10px; border-radius: 10px;" />
                                            </div>
                                            <div class="form-group" style="width:100%;">
                                                <label class="label" for="image">Upload new image (optional):</label>
                                                <input class="form-control" type="file" name="image" id="image" onchange="validateAndPreviewImage(event)" accept="image/png,image/jpeg,image/gif">
                                            ...
                                            <div class="form-group" style="width:100%;">
                                                ...
                                                <textarea class="form-control" name="desc" id="desc" maxlength="100"><%= thePost.getDescription() %></textarea>
                                            </div>                                       
                                            ...
                                            <div class="col text-end" style="align-content:center; display: flex; padding-left: 0px">
                                                ...
                                                <input class="btn btn-primary" type="submit" value="Save Changes" name="submit" style="margin: 20px;">
                                            </div><!--//col-->
