                    ...
                    <div class="app-auth-body mx-auto">
                        ...
                        <div class="auth-form-container text-start">
                            ...
                            <form method="post" action="../login" class="auth-form login-form">  
                                ...
                                <p class="error-message" style="color: red"><%= session.getAttribute("errorMsg") %></p>
                                <% } %>
                                <div class="email mb-3">
                                    <input id="signin-username" name="signin-username" class="form-control signin-email" placeholder="Email Address" required="required">
                                </div><!--//form-group-->
                            ...
                            <div class="auth-option text-center pt-5">
                                No Account? Sign up <a class="text-link" href="signup.jsp" >here</a>.<br>
                            </div>
